...
const file_proto_proto_rawDesc = "" +
	...
	"\x04Port\x18\x02 \x01(\x03R\x04Port\"O\n" +
	"\x05Reply\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\x12\x16\n" +
	"\x06toPort\x18\x02 \x01(\x03R\x06toPort\x12\x10\n" +
	"\x03ack\x18\x03 \x01(\x03R\x03ack2-\n" +
	"\vnodeService\x12\x1e\n" +
	"\x04send\x12\b.Request\x1a\x06.Reply\"\x00(\x010\x01B)Z'Ricart and Agrawala implementation/grpcb\x06proto3"
...
var file_proto_proto_depIdxs = []int32{
	0, // 0: nodeService.send:input_type -> Request
	1, // 1: nodeService.send:output_type -> Reply
